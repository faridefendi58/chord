...
class PostsController extends BaseController
{
    ...
    public function register($app)
    {
        ...
        $app->map(['GET', 'POST'], '/comment/[{id}]', [$this, 'get_comment']);
    }
    ...
    public function accessRules()
    {
        return [
            ['allow',
                'actions' => ['view', 'create', 'update', 'delete', 'comment'],
                'users'=> ['@'],
            ],
            ['deny',
                'users' => ['*'],
    ...
    public function get_comment($request, $response, $args)
    {
        $isAllowed = $this->isAllowed($request, $response);
        if ($isAllowed instanceof \Slim\Http\Response)
            return $isAllowed;
        ...
        return $this->_container->module->render($response, 'posts/comment.html', [
        ]);
    }
}